  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
	  <div class="container-fluid">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="index.php"><i class="glyphicon glyphicon-home"></i> Inicio</a></div>
	    ...
	    <div class="collapse navbar-collapse" id="topFixedNavbar1">
	      ...
	      <ul class="nav navbar-nav navbar-right">
	        ...
	        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-fw"></i> Usuario<span class="caret"></span></a>
	          <ul class="dropdown-menu">
