...
-- Script date 6/10/2018 2:44:22 p. m.
...
CREATE TABLE horas (
  ...
  Visible CHAR(2) NOT NULL DEFAULT 'SI',
...
SELECT
  ...
  horas.Descripcion AS Descripcion
FROM (precioshabitaciones
  JOIN horas
    ON ((precioshabitaciones.CodServicioHab = horas.id)))
WHERE ((precioshabitaciones.CodLista = listaSeleccionada) AND (precioshabitaciones.CodTipoHab = tipo) AND (horas.Estado = 'Activo') AND (precioshabitaciones.ValorServicio > 0) AND (horas.Visible = 'SI'))
  ORDER BY horas.Hora
$$

--
-- Definition for procedure S_Precio_HExtra
--
CREATE PROCEDURE S_Precio_HExtra(IN H INT, IN IdO INT, IN CLista INT, OUT precio double)
  SQL SECURITY INVOKER
BEGIN  
  SELECT
    precioshabitaciones.ValorServicio INTO precio
  FROM ocupacion
    INNER JOIN habitaciones
      ON ocupacion.NumeroHab = habitaciones.Numero
    INNER JOIN precioshabitaciones
      ON habitaciones.CodTipoHab = precioshabitaciones.CodTipoHab
  WHERE ocupacion.IdOcupacion = IdO AND precioshabitaciones.CodServicioHab = 25 AND precioshabitaciones.CodLista = CLista;  
  UPDATE ocupacion SET Horas = H, ValorExtra = precio*H, ValorTotal = (ValorServicio + ValorExtra + ValorConsumos)
    WHERE IdOcupacion = IdO;  
END
$$
...
(1, 1, 'Activo', 'SI', '1 HORA'),
(2, 2, 'Activo', 'SI', '2 HORAS'),
(3, 3, 'Activo', 'SI', '3 HORAS'),
(4, 4, 'Activo', 'SI', '4 HORAS'),
(5, 5, 'Inactivo', 'SI', '5 HORAS'),
(6, 6, 'Activo', 'SI', '6 HORAS'),
(7, 7, 'Inactivo', 'SI', '7 HORAS'),
(8, 8, 'Inactivo', 'SI', '8 HORAS'),
(9, 9, 'Inactivo', 'SI', '9 HORAS'),
(10, 10, 'Inactivo', 'SI', '10 HORAS'),
(11, 11, 'Inactivo', 'SI', '11 HORAS'),
(12, 12, 'Activo', 'SI', '12 HORAS'),
(13, 13, 'Inactivo', 'SI', '13 HORAS'),
(14, 14, 'Inactivo', 'SI', '14 HORAS'),
(15, 15, 'Inactivo', 'SI', '15 HORAS'),
(16, 16, 'Inactivo', 'SI', '16 HORAS'),
(17, 17, 'Inactivo', 'SI', '17 HORAS'),
(18, 18, 'Inactivo', 'SI', '18 HORAS'),
(19, 19, 'Inactivo', 'SI', '19 HORAS'),
(20, 20, 'Inactivo', 'SI', '20 HORAS'),
(21, 21, 'Inactivo', 'SI', '21 HORAS'),
(22, 22, 'Inactivo', 'SI', '22 HORAS'),
(23, 23, 'Inactivo', 'SI', '23 HORAS'),
(24, 24, 'Activo', 'SI', '24 HORAS'),
(25, 1, 'Activo', 'NO', 'HORA EXTRA');
...
(74, '101', 'TERMINADO', 5, NULL, 30000, 75000, 2500, 107500, '2018-07-27 18:06:52', NULL, 0, NULL),
(75, '202', 'TERMINADO', 5, NULL, 30000, 75000, 103500, 208500, '2018-07-27 18:06:59', NULL, 0, NULL),
(76, '204', 'TERMINADO', 5, NULL, 50000, 75000, 26500, 151500, '2018-07-27 18:07:04', NULL, 0, NULL),
(78, '205', 'TERMINADO', 21, NULL, 45000, 315000, 2500, 362500, '2018-07-30 17:54:09', NULL, 0, NULL),
(79, '206', 'TERMINADO', 23, NULL, 45000, 345000, 17000, 407000, '2018-07-30 17:57:52', NULL, 0, 'root@localhost'),
(80, '207', 'TERMINADO', 23, NULL, 25000, 345000, 9800, 379800, '2018-07-30 17:58:26', NULL, 0, 'root@localhost'),
(81, '301', 'TERMINADO', 24, NULL, 50000, 360000, 0, 410000, '2018-08-01 16:51:36', NULL, 0, 'root@localhost'),
(82, '302', 'TERMINADO', 6, NULL, 30000, 90000, 23800, 143800, '2018-08-21 10:17:43', NULL, 0, 'root@localhost'),
(83, '101', 'OCUPADO', 3, NULL, 30000, 0, 5000, 35000, '2018-09-21 18:54:04', NULL, 0, 'root@localhost'),
(84, '203', 'OCUPADO', 6, NULL, 45000, 0, 5000, 50000, '2018-09-21 18:54:31', NULL, 0, 'root@localhost'),
(85, '205', 'OCUPADO', 2, NULL, 50000, 30000, 0, 80000, '2018-09-21 18:54:37', NULL, 0, 'root@localhost'),
(86, '207', 'OCUPADO', 3, NULL, 35000, 0, 0, 35000, '2018-09-21 18:54:42', NULL, 0, 'root@localhost'),
(87, '102', 'OCUPADO', 12, NULL, 50000, 0, 0, 50000, '2018-09-21 18:54:48', NULL, 0, 'root@localhost');
...
(1, 'COCA COLA 600ML', 'COCA COLA', 2500, '6953070958389', 1, 'SI'),
(2, 'DETODITO', 'DETODITO', 2000, NULL, 3, 'SI'),
(3, 'PAPAS MARGARITAS', 'PAPAS', 3000, NULL, 3, 'SI'),
(4, 'PRESERVATIVOS TODAY', 'TODAY', 3500, NULL, 4, 'SI'),
(5, 'AGUA OASIS 600ML', 'AGUA', 2300, '7702090028836', 1, 'SI'),
(6, 'AGUA CARULLA 1.100ML', 'AGUA', 5000, '7701001740430', 1, 'SI'),
(7, 'HORA EXTRA SENCILLA', 'HORA EXTRA', 15000, NULL, 5, 'SI');
...
(74, 1, 1, 2500, 'root@localhost', '2018-09-20 15:18:42'),
(76, 2, 2, 2000, 'root@localhost', '2018-09-20 15:34:24'),
(83, 6, 1, 5000, 'root@localhost', '2018-09-21 18:56:51'),
(84, 6, 1, 5000, 'root@localhost', '2018-10-02 09:49:24');
